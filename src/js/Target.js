 ...
 *
 *  The top-level target living directly on the TA will not map to any
...
/**
 * Target constructor sets the target defaults. It includes a unique
 * id number for private tracking.
 */
function Target() {
...
Object.defineProperties(Target.prototype, {
  hasChildren: {
     ...
     * @return {Boolean} hasKids - true if there are chldren, false
     * otherwise.
     */
    get: function() {
      var hasKids = false;
  ...
  hasValue: {
     ...
     * @return {Boolean} somethingThere - true if a value exists,
     * false otherwise.
     */
    get: function() {
  ...
  hasGrandkids: {
    /**
     * Public method for determining if a Target’s children have
     * children.
     * @return {Boolean} hasGrandKids - true if there are
     * grandchildren, false otherwise.
     */
    get: function() {
